 ...
 * <ul>
 *   <li>{@code x-ignore-model=true} is present in schema extensions</li>
 *   <li>it is registered as an external model</li>
 * </ul>
 *
 * <p>Also keeps track of ignored models for later filtering steps.</p>
 */

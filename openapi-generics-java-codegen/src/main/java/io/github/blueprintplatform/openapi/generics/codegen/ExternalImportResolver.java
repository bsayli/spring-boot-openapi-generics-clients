 ...
 *
 * <p>Used for wrapper models (e.g. ServiceResponse&lt;T&gt;) where T is an external
 * contract type and must be imported instead of generated.</p>
 *
 * <p>Flow:</p>
 * <ul>
 *   <li>Detect wrapper model (x-api-wrapper)</li>
 *   <li>Extract inner type (x-data-item or x-api-wrapper-datatype)</li>
 *   <li>Resolve FQCN via {@link ExternalModelRegistry}</li>
 *   <li>Inject into x-extra-imports for template usage</li>
 * </ul>
 */
public class ExternalImportResolver {
    ...
    public void apply(CodegenModel model) {
        ...
        Optional<String> typeOpt =
                extract(ve, EXT_DATA_ITEM)
                        .or(() -> extract(ve, EXT_WRAPPER_DATATYPE));

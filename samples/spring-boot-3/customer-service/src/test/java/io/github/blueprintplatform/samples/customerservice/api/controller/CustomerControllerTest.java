...
class CustomerControllerTest {
  ...
  @Test
  @DisplayName("POST /customers -> 201 Created + ServiceResponse(data, meta)")
  ...
  @Test
  @DisplayName("GET /customers/{id} -> 200 OK + ServiceResponse(data, meta)")
  ...
  @Test
  @DisplayName("GET /customers -> 200 OK + Page<CustomerDto> + Meta.sort")
  void getCustomers_shouldReturnPaged() {
    ...
    // Meta + sort assertions (openapi-generics-contract: field is String)
  ...
  @Test
  @DisplayName("PUT /customers/{id} -> 200 OK + ServiceResponse(data, meta)")
  ...
  void deleteCustomer_shouldReturnNoContent() {
    ...
    ResponseEntity<Void> resp = controller.deleteCustomer(1);

...
class CustomerClientIT {
  ...
  void createCustomer_shouldReturn201_andMapBody() {
    ...
    assertEquals(1, resp.getData().customerId());
    assertEquals("Jane Doe", resp.getData().name());
    assertEquals("jane@example.com", resp.getData().email());
  ...
  void getCustomers_shouldReturn200_andMapPage() {
    ...
    assertEquals(1, page.content().getFirst().customerId());
  ...
  void updateCustomer_shouldReturn200_andMapBody() {
    ...
    assertNotNull(resp.getData());
    assertEquals(1, resp.getData().customerId());
    assertEquals("Jane Updated", resp.getData().name());
    assertEquals("jane.updated@example.com", resp.getData().email());

...
import static io.github.blueprintplatform.samples.customerservice.api.version.ApiVersions.V1;
...
public class CustomerController {
  ...
  @PostMapping(version = V1, consumes = MediaType.APPLICATION_JSON_VALUE)
